    ...
    <header className="portal-header" style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "1rem", flex: 1 }}>
        ...
        <div className="search-container-input hidden sm:block">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <line x1="21" x1="21" x2="16.65" y2="16.65" strokeWidth="2.5" />
          </svg>
          <input 
            type="text" 
            placeholder="Search students, sessions, schedule..." 
            value={searchTerm}
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "1.5rem" }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            <div style={{ width: "38px", height: "38px", borderRadius: "50%", background: "linear-gradient(135deg, #f43f5e 0%, #be123c 100%)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "700", color: "#fff", fontSize: "0.9rem" }}>
              {avatarInitials}
            </div>
            ...
            <div style={{
              ...
              {["June", "July", "August", "September", "October"].map((month) => (
                <button
                  key={month}
                  onClick={() => {
                    const el = document.getElementById(`faculty-month-column-${month}`);
                    if (el) {
            ...
            <div style={{
              ...
              {SKCET_CALENDAR_DATA.map((month, mIdx) => {
                ...
                return (
                  <div 
                    key={mIdx} 
                    id={`faculty-month-column-${monthNameOnly}`}
                    style={{
                      flex: "0 0 255px",
                      background: "var(--bg-secondary)",
                      border: "1px solid var(--card-border)",
